...
app.on('ready', () => {
  ...
  console.log('⌨️ Ctrl+Alt+Q registered:', quickEditResult);
  console.log('⌨️ Ctrl+Alt+W registered:', voiceRecordResult);
  console.log('⌨️ Ctrl+Alt+Right registered:', clipboardNextResult);
  console.log('⌨️ Ctrl+Alt+Left registered:', clipboardPrevResult);
  console.log('⌨️ Ctrl+Alt+C registered:', showClipboardResult);
  console.log('⌨️ Ctrl+Alt+E registered:', textToSpeechResult);
  
  if (!quickEditResult || !voiceRecordResult || !clipboardNextResult || !clipboardPrevResult || !showClipboardResult || !textToSpeechResult) {
    console.log('❌ Failed to register some global shortcuts');
  } else {
